...
from models import SignetModel
...
def main(args):
    ...
    logger_config = {
        "logging": {
            "project_name": f"{args.dataset}--fine-tuning",
            "run_name": f"fine-tuning-{args.dataset}-{args.task}",
    ...
    for epoch in tqdm(range(0, args.epochs)):
        ...
        if utils.is_main_process():
            ...
            dev_stats = evaluate(args, test_dataloader, model, model_without_ddp, phase='test')
