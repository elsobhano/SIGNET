...
from data import S2T_Large_Scale_dataset
...
from metrics import translation_performance
from config import *
...
def main(args):
    ...
    train_data = S2T_Large_Scale_dataset(path=train_label_paths[args.dataset], 
    ...
    dev_data = S2T_Large_Scale_dataset(path=dev_label_paths[args.dataset], 
                                args=args, phase='dev')
    print(dev_data)
